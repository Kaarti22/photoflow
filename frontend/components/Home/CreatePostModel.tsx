...
const CreatePostModel = ({ isOpen, onClose }: Props) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent>
        {previewImage ? (
          // Only show the selected image and input for caption when an image is choosen
          <div className="flex flex-col items-center justify-center text-center space-y-4">
            <div className="mt-4">
              <Image
                ...
                width={400}
                height={400}
                className="overflow-auto max-h-96 rounded-md object-contain w-fullF"
              />
            </div>
            <input
              type="text"
          ...
          <>
            <DialogHeader>
              <DialogTitle className="text-center mt-3 mb-4">
                Upload Photo
              </DialogTitle>
            </DialogHeader>
            <div className="flex flex-col items-center justify-center text-center space-y-4">
