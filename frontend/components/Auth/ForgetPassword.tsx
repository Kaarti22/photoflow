...
const ForgetPassword = () => {
  ...
  return (
    <div className="flex items-center justify-center flex-col w-full h-screen">
      ...
      <h1 className="text-2xl sm:text-3xl font-bold mb-3">Forgot Password ?</h1>
      ...
      <input
        ...
        placeholder="Enter your email"
              className="px-6 py-3.5 rounded-lg outline-none bg-gray-200 block w-[90%] sm:w-[80%] md:w-[60%] lg:w-[40%] xl-[30%] mx-auto "
              value={email}
